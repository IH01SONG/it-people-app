...
import { getAvailableCategories, getDefaultImageForCategory } from "../../utils/defaultImages";
  ...
  return (
    <Box sx={{ 
      ...
      <Container maxWidth="sm" sx={{ px: 3, py: 3, flex: 1 }}>
        ...
        {/* 안내 메시지 */}
        <Typography variant="h5" fontWeight={700} color="#333" mb={2} textAlign="center">
          어떤 활동을 함께하고 싶나요?
        </Typography>
            ...
            >
              <Box
                sx={{
                  ...
                  height: 48,
                  borderRadius: '50%',
                  bgcolor: selectedCategory === category ? '#E762A9' : '#f8f9fa',
                  display: 'flex',
                  alignItems: 'center',
